    ...
    <ul class="nav sidebar-nav">
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="http://localhost:8080/user/find">列表</a></li>
                <li><a href="http://localhost:8080/user/update">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="http://localhost:8080/user/product/find">列表</a></li>
                <li><a href="http://localhost:8080/user/product/update">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="http://localhost:8080/user/category/find">列表</a></li>
                <li><a href="http://localhost:8080/user/category/update">新增</a></li>
            </ul>
        </li>
